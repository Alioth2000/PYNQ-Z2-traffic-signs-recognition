...
w_conv1 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/w_conv1.bin",
...
B_conv1 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/b_conv1.bin", OUT_CH1)
for i in range(OUT_CH1):
    b_conv1[i] = B_conv1[i]

w_conv2 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/w_conv2.bin",
...
B_conv2 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/b_conv2.bin", OUT_CH2)
...
B_fc1 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/b_fc1.bin", OUT_CH3)
...
B_fc2 = readbinfile("/home/xilinx/jupyter_notebooks/GTSRB/data/b_fc2.bin", OUT_CH4)
...
while (1):
    while (1):
        ...
        break
    image1 = cv2.imread("/home/xilinx/jupyter_notebooks/GTSRB/image/01.ppm", cv2.IMREAD_GRAYSCALE).astype(np.float32)
    ...
    sign_name = ['20 Km/h', '30 Km/h', '50 Km/h', '60 Km/h', '70 Km/h', '80 Km/h', 'End 80 Km/h', '100 Km/h',
                 '120 Km/h', 'No overtaking',
                 'No overtaking for large trucks', 'Priority crossroad', 'Priority road', 'Give way', 'Stop',
                 'No vehicles',
                 ...
                 'No entry for vehicular traffic', 'Danger Ahead', 'Bend to left', 'Bend to right',
                 'Double bend (first to left)', 'Uneven road',
                 'Road slippery when wet or dirty', 'Road narrows (right)', 'Road works', 'Traffic signals',
                 'Pedestrians in road ahead', 'Children crossing ahead',
                 'Bicycles prohibited', 'Risk of snow or ice', 'Wild animals',
                 'End of all speed and overtaking restrictions', 'Turn right ahead', 'Turn left ahead',
                 'Ahead only', 'Ahead or right only', 'Ahead or left only', 'Pass by on right', 'Pass by on left',
    ...
    print("The sign is: " + sign_name[result])
